...
public class Load8BitRegisterAIntoHLAddressAndIncrementHLTest extends InstructionTest {

  @Test public void shouldUseTwoCyclesAsLastInstructionExecutionTime() {
    Instruction instruction = new Load8BitRegisterAIntoHLAddressAndIncrementHL(z80, mmu);
  ...
  @Test public void shouldIncrementHL() {
  ...
  @Test public void shouldLoadRegisterAValueIntoTheHLAddress() {
