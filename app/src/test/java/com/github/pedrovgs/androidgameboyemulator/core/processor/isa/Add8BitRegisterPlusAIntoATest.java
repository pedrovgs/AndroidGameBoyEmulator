...
public class Add8BitRegisterPlusAIntoATest extends InstructionTest {

  @Test public void shouldUseOneCycleAsLastInstructionExecutionTime() {
    Instruction instruction = new Add8BitRegisterPlusAIntoA(z80, ANY_8BIT_SOURCE_REGISTER);
  ...
  public void shouldNotAccept16BitRegistersAsSourceRegister() {
    Instruction instruction = new Add8BitRegisterPlusAIntoA(z80, ANY_16BIT_SOURCE_REGISTER);

    instruction.execute();
  }

  @Test public void shouldSumSourceRegisterValuePlusARegisterValueAndUpdateA() {
    ...
    byte expectedValue = ANY_8BIT_REGISTER_VALUE + ANY_8BIT_REGISTER_VALUE;
