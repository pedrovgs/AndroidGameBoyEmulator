...
public class Add8BitAddressHLPlusAIntoATest extends InstructionTest {

  @Test public void shouldUseTwoCyclesAsLastInstructionExecutionTime() {
    Instruction instruction = new Add8BitAddressHLPlusAIntoA(z80, mmu);
  ...
  @Test
  public void shouldSumTheContentOfTheMemoryPointedByTheRegisterHLToAAndLoadsTheResultIntoA() {
    ...
    byte expectedSum = ANY_8BIT_REGISTER_VALUE + ANY_MEMORY_BYTE_VALUE;
