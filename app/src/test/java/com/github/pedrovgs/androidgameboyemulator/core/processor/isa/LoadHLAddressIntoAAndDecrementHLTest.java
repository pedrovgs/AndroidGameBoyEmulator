...
public class LoadHLAddressIntoAAndDecrementHLTest extends InstructionTest {

  @Test public void shouldUseTwoCyclesAsLastInstructionExecutionTime() {
    Instruction instruction = new LoadHLAddressIntoAAndDecrementHL(z80, mmu);
  ...
  @Test public void shouldDecrementHLRegister() {
