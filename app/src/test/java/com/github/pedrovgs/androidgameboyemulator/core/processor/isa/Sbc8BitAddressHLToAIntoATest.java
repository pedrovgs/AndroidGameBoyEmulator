...
public class Sbc8BitAddressHLToAIntoATest extends InstructionTest {

  @Test public void shouldUseOneCycleAsLastInstructionExecutionTime() {
    Instruction instruction = new Sbc8BitAddressHLToAIntoA(z80, mmu);
  ...
  @Test public void shouldSubtractTheMemoryValuePointedByHLPlusCYFlagPlusAAndStoreTheResultIntoA() {
    z80.enableFlagCY();
