...
public class Dec16BitRegisterTest extends InstructionTest {

  @Test public void shouldUseTwoCyclesAsLastInstructionExecutionTime() {
    Instruction instruction = new Dec16BitRegister(z80, ANY_16BIT_DESTINY_REGISTER);
  ...
  @Test public void shouldDecrementTheValueOfTheDestinyRegister() {
