...
public class Load8BitRegisterAIntoHLAddressAndDecrementHLTest extends InstructionTest {

  @Test public void shouldUseTwoCyclesAsLastInstructionExecutionTime() {
    Instruction instruction = new Load8BitRegisterAIntoHLAddressAndDecrementHL(z80, mmu);
  ...
  @Test public void shouldDecrementHL() {
