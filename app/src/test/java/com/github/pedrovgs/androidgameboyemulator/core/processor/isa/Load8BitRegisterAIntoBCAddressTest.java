...
public class Load8BitRegisterAIntoBCAddressTest extends InstructionTest {

  @Test public void shouldUseTwoCyclesAsLastInstructionExecutionTime() {
    Instruction instruction = new Load8BitRegisterAIntoBCAddress(z80, mmu);
  ...
  @Test public void shouldLoadTheRegisterAValueIntoTheMemoryPointedByTheRegisterBC() {
