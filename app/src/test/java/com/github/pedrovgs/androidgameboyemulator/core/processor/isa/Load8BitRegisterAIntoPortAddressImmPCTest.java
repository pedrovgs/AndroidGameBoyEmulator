...
public class Load8BitRegisterAIntoPortAddressImmPCTest extends InstructionTest {

  @Test public void shouldIncrementProgramCounterInOneUnit() {
    z80.setProgramCounter(ANY_16BIT_REGISTER_VALUE);
    Instruction instruction = new Load8BitRegisterAIntoPortAddressImmPC(z80, mmu);
  ...
  @Test public void shouldLoad8BitRegisterAIntoTheAddressPointedByThePCImmPortAddress() {
    z80.setProgramCounter(ANY_16BIT_REGISTER_VALUE);
    ...
    int expectedAddress = (ANY_16BIT_REGISTER_VALUE + 1 & 0xFF) + 0xFF00;
