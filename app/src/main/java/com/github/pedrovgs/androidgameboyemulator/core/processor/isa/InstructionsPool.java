...
public class InstructionsPool {
  ...
  private void generateNormalInstructions(GBZ80 z80, MMU mmu) {
    ...
    normalInstructions[0x70] = new Load8BitRegisterIntoHLAddress(z80, mmu, Register.B);
    normalInstructions[0x71] = new Load8BitRegisterIntoHLAddress(z80, mmu, Register.C);
    normalInstructions[0x72] = new Load8BitRegisterIntoHLAddress(z80, mmu, Register.D);
    normalInstructions[0x73] = new Load8BitRegisterIntoHLAddress(z80, mmu, Register.E);
    normalInstructions[0x74] = new Load8BitRegisterIntoHLAddress(z80, mmu, Register.H);
    normalInstructions[0x75] = new Load8BitRegisterIntoHLAddress(z80, mmu, Register.L);
    ...
    normalInstructions[0x7E] = new Load8BitHLAddressInto8BitRegister(z80, mmu, Register.A);
    normalInstructions[0xFA] = new Load8BitImmPCWordIntoA(z80, mmu);
    ...
    normalInstructions[0xDC] = new Call(z80, mmu, FLAG_C, JUMP_CARRY);
    ...
    normalInstructions[0xD8] = new Ret(z80, mmu, FLAG_C, JUMP_CARRY);
  ...
  private void generateExtendedInstructions(GBZ80 z80, MMU mmu) {
    ...
    extendedInstructions[0x07] = new RotateLeftCarry8BitRegister(z80, Register.A);
    ...
    extendedInstructions[0x17] = new RotateLeft8BitRegister(z80, Register.A);
    ...
    extendedInstructions[0x1F] = new RotateRight8BitRegister(z80, Register.A);
